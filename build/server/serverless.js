...
var init__ = __esm({
  "build/nodes/0.js"() {
    ...
    imports = ["_app/immutable/nodes/0.LuceE1mR.js", "_app/immutable/chunks/scheduler.V7bLW0bx.js", "_app/immutable/chunks/index.mN9cRR75.js"];
    stylesheets = ["_app/immutable/assets/app.H5y-RLEa.css"];
    fonts = [];
  }
});
...
var init__2 = __esm({
  "build/nodes/1.js"() {
    ...
    imports2 = ["_app/immutable/nodes/1.WjK7Y_nN.js", "_app/immutable/chunks/scheduler.V7bLW0bx.js", "_app/immutable/chunks/index.mN9cRR75.js", "_app/immutable/chunks/singletons.29Dy3bnL.js"];
    stylesheets2 = [];
    fonts2 = [];
  }
});
...
var headerText, bodyText, Header, Line, Apropos, Project, sections, marteau, projetequipe, Projetequipetest, Page;
var init_page_svelte = __esm({
  "build/entries/pages/_page.svelte.js"() {
    ...
    headerText = [
      {
        text1: {
          fr: "Int\xE9grateur multim\xE9dia",
          eng: "Multimedia integrator"
        }
      },
      {
        text2: {
          fr: "Je suis une personne cr\xE9ative qui aime apprendre. Int\xE9ress\xE9 principalement en technologie et en jeux vid\xE9o, mon r\xEAve est de travailler sur la programmation de jeux ambitieux qui r\xE9volutionneront l\u2019univers vid\xE9o ludique. ",
    ...
    bodyText = [
      {
        text1: {
          fr: "En 2021, j'ai commenc\xE9 mes \xE9tudes d'int\xE9grations multim\xE9dia au ",
          eng: "In 2021, I began my multimedia integration studies at "
        }
      },
      {
        text2: {
          fr: ". Au travers de mes \xE9tudes j'ai pu apprendre plusieurs comp\xE9tences fondamentales en programmation et j\u2019ai aussi appris les bases des logiciels Adobe tel que Photoshop, Illustrator, Premiere et After Effects. ",
      ...
      {
        text3: {
          fr: "Aux travers des travaux r\xE9aliser j\u2019ai pus m\u2019\xE9panouir en temps que *leader* d\u2019\xE9quipe. En effet j\u2019ai \xE9t\xE9 la charg\xE9e de projet dans plusieurs travaux r\xE9alis\xE9s au cours de mon parcours scolaire et j\u2019ai pu les mener \xE0 bon terme en des travaux dont je suis fier. J\u2019ai appris la gestion d\u2019\xE9quipe, le professionnalisme, l'environnement de travail Github mais aussi comment vendre un produit en travaillant en collaboration avec mes clients, en pratiquant l\u2019analyse concurrentielle et en menant de profonde r\xE9trospective par rapport \xE0 mon produit.",
      ...
      {
        text4: {
          fr: "Quand je ne pratique pas ma programmation, j\u2019aime me perdre dans ma passion des jeux vid\xE9os en d\xE9couvrant de nouveaux univers. Je suis aussi un joueur de ",
      ...
      {
        text6: {
          fr: ", sport dans lequel j\u2019ai remport\xE9 de nombreuses m\xE9dailles d'or au provincial et une m\xE9daille de bronze au championnat canadien junior en \xE9quipe.",
      ...
      {
        text7: {
          fr: "De 2019 \xE0 2020, j\u2019ai ",
          eng: "From 2019 to 2020, I "
        }
      },
      {
        text8: {
          fr: "\xE9tudi\xE9 au japon",
          eng: "studied in japan"
        }
      },
      {
        text9: {
          fr: "tout en travaillant pour payer mes \xE9tudes. Durant ce parcours j\u2019ai appris le japonais et plusieurs comp\xE9tences de vie. J\u2019ai aussi beaucoup appris de leurs culture de respect et de professionnalisme.",
    ...
    Apropos = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      let { lang } = $$props;
      const prerender = true;
      if ($$props.lang === void 0 && $$bindings.lang && lang !== void 0)
        $$bindings.lang(lang);
    ...
    sections = [
      {
        ...
        descriptionfr: "Dans un pays diviser deux peuples autrefois unis se combattent. Le premier peuple est le peuple du feu qui vit dans un d\xE9sert presque sans v\xE9g\xE9tation. Les membres de ce peuple sont des barbares nomades qui vivent principalement de la chasse. Ils ont une tradition orale chanter, donc il transmette leurs savoir principalement par des chansons. La valeur qu'ils se transmette et qui est la plus importante est la force. Leur devise : \xAB Forger le clan par le feu et la force \xBB Les membres du clan poss\xE8dent des v\xEAtements de teinte rouge car la seule plante qu'il est possible de trouver dans leur terre d\xE9sertique est une plante qui leurs permettent de cr\xE9er une teinture d'un rouge magnifique. Ce rouge repr\xE9sente en m\xEAme temps le feu et leurs nature combattante. Leurs v\xEAtements sont tr\xE8s pratiques. Ils n'ont pas fioriture ou d'important \xE9l\xE9ment d'esth\xE9tique le peuple du feu ne voit pas d'int\xE9r\xEAt \xE0 mettre des v\xEAtements pour une autre raison que la protection.",
      ...
      {
        titre: "Signet",
        descriptionfr: "Application en ligne utilisant une base de donn\xE9e firebase pour afficher des aides m\xE9moires. Application permettant d'ajoutez, modifier, enlevez des aides m\xE9moires dinamyquement et facilement. La base de donn\xE9e est diff\xE9rente par utilisateur et permet de se connecter avec google.",
      ...
      {
        titre: "M\xE9mo application web",
        descriptionfr: "Application web permettant d'afficher des t\xE2ches, d'ajoutez des t\xE2ches et de filtrer des t\xE2ches.Simple et facile \xE0 utilis\xE9e, cette application permet de se rapeller ses t\xE2ches pour la journ\xE9e et de les faire \xE0 temps. Filtrage de t\xE2che par si elle sont compl\xE9t\xE9es ou non, ajout de t\xE2che, \xE9l\xE9ments visuel pour diff\xE9rencier les t\xE2ches, heure \xE0 laquelle une t\xE2che \xE0 \xE9t\xE9 ajouter.",
    ...
    marteau = "/_app/immutable/assets/marteau.UfHW56Cj.jpg";
    projetequipe = [
      {
        titre: "Le Royaumme d'Alcantara",
        descriptionfr: "Alcantara est un jeu low-poly m\xE9di\xE9val de survie contre des vagues d'ennemies. Le joueur devra d\xE9fendre le royaume d\u2019Alcantara contre l\u2019invasion des ravageurs en d\xE9truisant les portails qui les relient au royaume.",
      ...
      },
      {
        ...
        descriptionfr: "Tur5o est un prototype de site web cr\xE9er \xE0 la demande des professeurs du programme d'int\xE9gration multim\xE9dia du coll\xE8ge de Maisonneuve. Le site web a \xE9t\xE9 cr\xE9\xE9 avec wordpress et d\xE9ploy\xE9 sur Siteground.",
    ...
    Projetequipetest = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      let { descriptionfr } = $$props;
      let { descriptioneng } = $$props;
      let { lang } = $$props;
      let { titre } = $$props;
    ...
    Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      ...
      })}</ol></section> <div data-svelte-h="svelte-1am6gkm">@Fait \xE0 Montr\xE9al</div> <div data-svelte-h="svelte-1jocvpn">Fait avec Svelte Tailwindcss</div></main> </div>`;
    });
  }
});
...
var init__3 = __esm({
  "build/nodes/2.js"() {
    ...
    imports3 = ["_app/immutable/nodes/2.wYTRiuoT.js", "_app/immutable/chunks/scheduler.V7bLW0bx.js", "_app/immutable/chunks/index.mN9cRR75.js"];
    stylesheets3 = ["_app/immutable/assets/app.H5y-RLEa.css"];
    fonts3 = [];
  }
});
...
async function respond(request, options2, manifest2, state) {
  ...
  const event = {
    ...
    getClientAddress: state.getClientAddress || (() => {
      throw new Error(
        `${"adapter-serverless"} does not specify getClientAddress. Please raise an issue`
      );
    }),
    locals: {},
    params,
...
var manifest = (() => {
  ...
  return {
    appDir: "_app",
    appPath: "_app",
    assets: /* @__PURE__ */ new Set([".nojekyll", "alcantara.png", "favicon.png"]),
...
async function handler(event, context) {
  ...
  const { rawPath, headers: headers2, rawQueryString, body: body2, requestContext, isBase64Encoded, cookies } = event;
  const encoding = isBase64Encoded ? "base64" : headers2["content-encoding"] || "utf-8";
  const domainName = headers2["x-forwarded-host"];
  const rawBody = typeof body2 === "string" ? Buffer.from(body2, encoding) : body2;
  if (cookies) {
    headers2["cookie"] = cookies.join("; ");
  }
